  ...
  >
    ...
    <div className="px-6 mt-6 space-y-4">
      ...
      <motion.div
        ...
        className="bg-white dark:bg-slate-800 rounded-[1.5rem] p-5 border-2 border-rose-100 dark:border-rose-900/30 flex items-center justify-between cursor-pointer active:scale-95 transition-transform shadow-sm"
      >
        <div className="flex items-center gap-4">
